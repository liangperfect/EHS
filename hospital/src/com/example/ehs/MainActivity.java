...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		map.put("img", R.drawable.chat_2);
		map.put("str", "聊天");
		items.add(map);
		map = new HashMap<String, Object>();
		map.put("img", R.drawable.notice_2);
		map.put("str", "通知");
		items.add(map);
		map = new HashMap<String, Object>();
		map.put("img", R.drawable.query_2);
		map.put("str", "查询");
		items.add(map);
		map = new HashMap<String, Object>();
		...
		items.add(map);
		map = new HashMap<String, Object>();
		map.put("img", R.drawable.vedio_2);
		map.put("str", "视频会诊");
		items.add(map);
		map = new HashMap<String, Object>();
		map.put("img", R.drawable.order_2);
		map.put("str", "快速订餐");
		items.add(map);
		map = new HashMap<String, Object>();
		...
		items.add(map);
		map = new HashMap<String, Object>();
		map.put("img", R.drawable.shopping_2);
		map.put("str", "购物");
		items.add(map);
		map = new HashMap<String, Object>();
		map.put("img", R.drawable.setting_2);
		map.put("str", "设置");
		items.add(map);
