...
public class LoginActivity extends ALoginActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Toast.makeText(LoginActivity.this, "长按登陆按钮可以更改服务器IP地址",
				Toast.LENGTH_LONG).show();
		System.out.println("测试用的代码");
		setupView();
	}
	...
	private void setupView() {
		...
		loginView.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				Toast.makeText(LoginActivity.this, "更改服务器IP",
								...
								new DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
										...
										ConnectionUtils connectionUtils = new ConnectionUtils(
												host);
										System.out.println("hostzzz="
												+ connectionUtils.getHost());
									}
		...
		if (savePassword.isChecked()) {
			...
			if (autoLogin.isChecked()) {
				...
				System.out.println("userInfo=" + userInfo.getAccount() + ","
						+ userInfo.getPassword() + "," + userInfo.getSavePswd()
