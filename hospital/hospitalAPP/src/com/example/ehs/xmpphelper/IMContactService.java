...
public class IMContactService extends Service {
	...
	private void addSubscriptionListener() {
		...
		ConnectionUtils.getConnection().addPacketListener(
	...
	private void initRoster() {
		roster = ConnectionUtils.getConnection().getRoster();
		roster.removeRosterListener(rosterListener);
		roster.addRosterListener(rosterListener);
		ContacterManager.init(ConnectionUtils.getConnection());
	}
	...
	public void onDestroy() {
		// 释放资源
		ConnectionUtils.getConnection().removePacketListener(
