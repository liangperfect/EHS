...
//	private Button rightBtView;
	...
	private void setUpView() {
		...
		tabHost.addTab(tabHost.newTabSpec("医院简介")  
                .setIndicator("医院简介",getResources().getDrawable(R.drawable.hosptal))
		...
		tabHost.addTab(tabHost.newTabSpec("医生查询")  
                .setIndicator("医生查询",getResources().getDrawable(R.drawable.doctor))  
